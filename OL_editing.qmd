...
O_Rub_gill = read.csv("ruby.freq.csv", header = T)
...
all=rbind(lb,O_Rub_gill)
all=all[order(all$edit),]
desired_order <- c("O_Rub_gill", "Squid", "Sepia", "O_vulgaris", "O_bimac", "Nautilus", "Sea hare")
all$species <- factor(all$species, levels = desired_order)



barplot(all$prop,col=c("#2a3188","#568ed2","#62c331","#f25031","#97191e","#efee0e","purple"),space=c(0,rep(c(0,0,0,0,0,0,1),12)))
