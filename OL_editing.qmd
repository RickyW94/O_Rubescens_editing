...
This is Jaydee's original plot code. The problem is that he pulls exact values for means from each dataset and I'm not sure where he gets those. I can't simply add in my dataframe and make it work because it's not expandable...
